...
/*                                                                          */
/*          Exemple 11 : Exploitation du flux squelette de la Kinect V1     */
/*                                                                          */
/* Exemple_11_Kinect_Skeleton.pde                      Processing 3.5.4     */
/****************************************************************************/
...
void setup() {
  ...
  size(640, 480);
  surface.setTitle("Exemple 11 - La Kinect en mode Squelette - E. Mesnard / ISIMA");
